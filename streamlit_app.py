...
row0_1.title('Empowering the Automotive Industry with Data Analytics')


with row0_2:
    st.write('Use Data to Get to know about your customers and their needs.')

row0_2.subheader(
    'A Streamlit web app by [Vanshita Sharma]')

row1_spacer1, row1_1, row1_spacer2 = st.columns((.1, 3.2, .1))

with row1_1:
    st.markdown("Hey there! Welcome to Automotive Industry Data Analysis App. If you're on a mobile device, switch over to landscape for viewing ease. Give it a go!")
    st.markdown(
...
with row7_1:
    ...
    st.markdown('***')
    st.markdown(
        "Thanks for going through this data-analysis with me! I'd love feedback on this, so if you want to reach out you can find me on [twitter] (https://twitter.com/tylerjrichards) or my [website](http://www.tylerjrichards.com/).")
